...
def test_open_login_page(live_server, new_client):
    ...
    Попадает на страницу с title 'Войти' и заголовком
    И надписью ВХОД
    Вводит логин и пароль и переходит на главную
    """
    browser = webdriver.Chrome('C:\\Users\\2\\PycharmProjects\\ToDoList\ToDoList\chromedriver.exe')
